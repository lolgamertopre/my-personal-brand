...
import './App.css'; // This imports the hover effects we just wrote!
      ...
      <div style={styles.container}>
        <header style={styles.header}>
          ...
          <div style={styles.socialLinks}>
            {/* Using our new CSS classes here */}
          ...
          <div style={styles.projectList}>
            {profile.projects.map((proj, index) => (
              <div key={index} className="project-card">
                ...
                <a href={proj.link} target="_blank" rel="noreferrer" className="project-link">View Project →</a>
              </div>
            ))}
          </div>
        </section>
...
// Background and layout styles stay here
const styles = {
  backgroundWrapper: {
    minHeight: '100vh',
  ...
  container: { maxWidth: '750px', margin: '0 auto', position: 'relative', zIndex: 1 },
  badge: {
    ...
    fontWeight: '600', border: '1px solid rgba(59, 130, 246, 0.3)', marginBottom: '1rem'
  },
  ...
  projectDescription: { fontSize: '0.95rem', color: '#94a3b8', margin: '0 0 0.5rem 0', lineHeight: '1.5' }
};
